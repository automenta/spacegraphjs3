...
(async () => {
  ...
  try {
    ...
    console.log(
      'Comprehensive demo screenshot saved to doc/screenshots/comprehensive-demo.png'
    );
    ...
    await page.screenshot({
      path: path.join(
        process.cwd(),
        'doc/screenshots/comprehensive-demo-closeup.png'
      ),
      clip: { x: 300, y: 200, width: 600, height: 400 },
    });

    console.log(
      'Close-up screenshot saved to doc/screenshots/comprehensive-demo-closeup.png'
    );
    ...
    if (layoutButtons.length > 0) {
      ...
      console.log(
        'Grid layout screenshot saved to doc/screenshots/grid-layout.png'
      );
    }
