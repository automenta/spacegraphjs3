...
(async () => {
  ...
  try {
    ...
    await page.screenshot({
      path: path.join(
        process.cwd(),
        'doc/screenshots/instanced-interaction-basic-renderer.png'
      ),
      fullPage: true,
    });

    console.log(
      'Instanced interaction with BasicRenderer screenshot saved to doc/screenshots/instanced-interaction-basic-renderer.png'
    );
