...
export const initialNodes: AppNode[] = [
  // Root level nodes
  { id: '1', type: 'fractal-node', position: { x: 0, y: 0 }, data: { label: 'Explore This Fractal', depth: 0, width: 350 } },
  ...
  { id: '1-1', type: 'fractal-node', position: { x: 50, y: 50 }, data: { label: 'Inner Fractal 1', parentId: '1', depth: 1, width: 250 } },
