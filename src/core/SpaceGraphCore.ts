 ...
 */
export class SpaceGraphCore {
  private static elementActorRegistry: Map<string, ElementActorClass> =
    new Map();

  // Initialize the registry with default element actors
  static {
    SpaceGraphCore.elementActorRegistry.set('sphere', SphereElementActor);
    SpaceGraphCore.elementActorRegistry.set('box', BoxElementActor);
    SpaceGraphCore.elementActorRegistry.set('custom', CustomGeometryActor);
    SpaceGraphCore.elementActorRegistry.set('text', TextElementActor);
    SpaceGraphCore.elementActorRegistry.set('html', HtmlNodeElementActor);
  }
  ...
  constructor(
    ...
    try {
      ...
      if (
        ...
        SpaceGraphCore.isDevelopmentMode()
      ) {
        console.warn(
  ...
  public static registerType(name: string, actorClass: ElementActorClass) {
    SpaceGraphCore.elementActorRegistry.set(name, actorClass);
  }

  public static getElementActorRegistry() {
    return SpaceGraphCore.elementActorRegistry;
  }

  public static registerLayout(name: string, engineClass: LayoutEngineClass) {
    SpaceGraphCore.layoutEngineRegistry.set(name, engineClass);
  }

  public static getLayoutEngineRegistry() {
    return SpaceGraphCore.layoutEngineRegistry;
  }
  ...
  public static registerInstancedType(
    ...
    SpaceGraphCore.instancedGeometryRegistry.set(name, geometry);
  }

  public static getInstancedGeometryRegistry() {
    return SpaceGraphCore.instancedGeometryRegistry;
  }
  ...
  public update(spec: SpecUpdate) {
    try {
      ...
      if (SpaceGraphCore.isDevelopmentMode() && spec.data) {
