...
test.describe('UI/UX Ergonomics Validation', () => {
  ...
  test('Screen reader accessibility', async ({ page: _page }) => {
    ...
    console.log(`Accessibility attributes: ${JSON.stringify(accessibilityAttributes)}`);
  ...
  test('Visual feedback for interactions', async ({ page: _page }) => {
    ...
    console.log(`Visual feedback test: hover=${!!hoverState.hoveredElement}, selected=${clickState.selectedElements.length}`);
  });
});