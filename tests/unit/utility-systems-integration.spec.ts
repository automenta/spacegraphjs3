...
describe('Utility Systems Integration', () => {
  ...
  describe('CameraUtils Integration', () => {
    ...
    it('should calculate optimal distance for framing', () => {
      ...
      const distance = CameraUtils.calculateOptimalDistance(
        boundingRadius,
        camera
      );
  ...
  describe('HUDUtils Integration', () => {
    ...
    it('should create HUD panels', () => {
      const { panel, header, contentArea } = HUDUtils.createDraggablePanel(
        'test-panel',
        'Test Panel',
        'Test content',
        {
  ...
  describe('InteractionUtils Integration', () => {
    it('should handle mouse events', () => {
      ...
      const interaction =
        utilitySystem.interaction.handleMouseEvent(mouseEvent);
    ...
    it('should calculate velocity from position history', () => {
      ...
      const velocity = utilitySystem.interaction.calculateVelocity(
        positions,
        timestamps
      );
    ...
    it('should handle touch gestures', () => {
      ...
      const events =
        utilitySystem.interaction.detectMultiTouchGestures(touches);
  ...
  describe('PerformanceUtils Integration', () => {
    it('should start and stop monitoring', () => {
      ...
      expect(utilitySystem.performance.getMetrics().fps).toBeGreaterThanOrEqual(
        0
      );
    ...
    it('should measure render time', async () => {
      ...
      const { result, renderTime } =
        await utilitySystem.performance.measureRenderTime(operation);
    ...
    it('should provide performance recommendations', () => {
      const recommendations =
        utilitySystem.performance.getPerformanceRecommendations();
