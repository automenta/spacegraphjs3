...
test.describe('Comprehensive UI Visual Semantics', () => {
  ...
  test('Text Element Actor visual semantics', async () => {
    ...
    await controller.assertVisualState(ComprehensiveUISemanticsSpecs.TextElementActorSpec);
    await controller.assertErgonomicCompliance(ComprehensiveUISemanticsSpecs.TextElementActorSpec);
  });
  ...
  test('HTML Node Element Actor visual semantics', async () => {
    ...
    await controller.assertVisualState(ComprehensiveUISemanticsSpecs.HtmlNodeElementActorSpec);
    await controller.assertErgonomicCompliance(ComprehensiveUISemanticsSpecs.HtmlNodeElementActorSpec);
  });
  ...
  test('Edge Renderer visual semantics', async () => {
    ...
    await controller.assertVisualState(ComprehensiveUISemanticsSpecs.EdgeRendererSpec);
    await controller.assertErgonomicCompliance(ComprehensiveUISemanticsSpecs.EdgeRendererSpec);
  });
  ...
  test('Edge Label visual semantics', async () => {
    ...
    await controller.assertVisualState(ComprehensiveUISemanticsSpecs.EdgeLabelSpec);
    await controller.assertErgonomicCompliance(ComprehensiveUISemanticsSpecs.EdgeLabelSpec);
  });
  ...
  test('Selection Manager visual semantics', async () => {
    ...
    await controller.assertErgonomicCompliance(ComprehensiveUISemanticsSpecs.SelectionManagerSpec);
  });
  ...
  test('Context Menu visual semantics', async () => {
    ...
    await controller.assertVisualState(ComprehensiveUISemanticsSpecs.ContextMenuSpec);
    await controller.assertErgonomicCompliance(ComprehensiveUISemanticsSpecs.ContextMenuSpec);
  });
  ...
  test('Circle Layout visual semantics', async () => {
    ...
    await controller.assertVisualState(ComprehensiveUISemanticsSpecs.CircleLayoutSpec);
    await controller.assertErgonomicCompliance(ComprehensiveUISemanticsSpecs.CircleLayoutSpec);
  });
  ...
  test('Grid Layout visual semantics', async () => {
    ...
    await controller.assertVisualState(ComprehensiveUISemanticsSpecs.GridLayoutSpec);
    await controller.assertErgonomicCompliance(ComprehensiveUISemanticsSpecs.GridLayoutSpec);
  });
  ...
  test('HUD visual semantics', async () => {
    ...
    await controller.assertErgonomicCompliance(ComprehensiveUISemanticsSpecs.HUDSpec);
  });
  ...
  test('Performance Overlay visual semantics', async () => {
    ...
    await controller.assertVisualState(ComprehensiveUISemanticsSpecs.PerformanceOverlaySpec);
    await controller.assertErgonomicCompliance(ComprehensiveUISemanticsSpecs.PerformanceOverlaySpec);
  });
  ...
  test('Search Filter visual semantics', async () => {
    ...
    await controller.assertVisualState(ComprehensiveUISemanticsSpecs.SearchFilterSpec);
    await controller.assertErgonomicCompliance(ComprehensiveUISemanticsSpecs.SearchFilterSpec);
  });
  ...
  test('Camera Controls visual semantics', async () => {
    ...
    await controller.assertErgonomicCompliance(ComprehensiveUISemanticsSpecs.CameraControlsSpec);
  });
  ...
  test('Instanced Renderer visual semantics', async () => {
    ...
    await controller.assertVisualState(ComprehensiveUISemanticsSpecs.InstancedRendererSpec);
    await controller.assertErgonomicCompliance(ComprehensiveUISemanticsSpecs.InstancedRendererSpec);
  });
});