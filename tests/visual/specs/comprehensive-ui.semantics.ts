...
export const SphereElementActorSpec: VisualSemanticsSpec = {
  ...
  interactions: [
    ...
    },
    {
      ...
      expectedOutcomes: [
        {
          description: 'Sphere element actor should become semi-transparent when dragged',
...
export const BoxElementActorSpec: VisualSemanticsSpec = {
  ...
  interactions: [
    ...
    },
    {
      ...
      expectedOutcomes: [
        {
          description: 'Box element actor should become semi-transparent when dragged',
  ...
  interactions: [
    {
      ...
      expectedOutcomes: [
        {
          description: 'HTML node element actor should have subtle hover effect',
    ...
    },
    {
      ...
      expectedOutcomes: [
        {
          description: 'HTML node element actor should have selection highlight',
...
export const EdgeLabelSpec: VisualSemanticsSpec = {
  ...
  interactions: [
    ...
    },
    {
      ...
      expectedOutcomes: [
        {
          description: 'Edge label should become bold and change color when selected',
  ...
  interactions: [
    {
      ...
      steps: [
        { type: 'click', target: '#renderer-toggle' }
      ],
      expectedOutcomes: [
        {
          description: 'Renderer should switch between instanced and standard modes',
  ...
  interactions: [
    {
      ...
      steps: [
        { type: 'click', target: '#force-layout-button' }
      ],
      expectedOutcomes: [
        {
  ...
  interactions: [
    {
      ...
      steps: [
        { type: 'click', target: '#circle-layout-button' }
      ],
      expectedOutcomes: [
        {
  ...
  interactions: [
    {
      ...
      steps: [
        { type: 'click', target: '#grid-layout-button' }
      ],
      expectedOutcomes: [
        {
